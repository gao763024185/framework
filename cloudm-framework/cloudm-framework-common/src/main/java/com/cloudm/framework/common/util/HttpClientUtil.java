...
public class HttpClientUtil {
    ...
    public static String httpPostRequest(String url, Map<String, Object> headers, Map<String, Object> params) {
        ...
        try {
            ...
            log.error(ClassUtil.getExcCodeError(HttpUtil.class) + ",{}!设置编码错误,异常信息为:{}", url, e);
            throw new BusinessProcessFailException(BaseErrorEnum.SYS_ERROR);
        }
        return getResult(httpPost);
    }
...
//        CloseableHttpClient httpClient = getHttpClient();
        ...
        try {
            ...
            throw new BusinessProcessFailException(BaseErrorEnum.RPC_ERROR);
        } catch (BusinessProcessFailException | IOException e) {
            log.error(ClassUtil.getExcCodeError(HttpUtil.class) + ",{}! 远程处理异常,异常信息为:{}",
                    request.getURI().toString(), e);
            throw new BusinessProcessFailException(BaseErrorEnum.SYS_ERROR);
        } catch (Exception e) {
            log.error(ClassUtil.getExcCodeError(HttpUtil.class) + ",{}! 连接出错，可能远程服务器挂掉了,异常信息为:{}",
                    request.getURI().toString(), e);
            throw new BusinessProcessFailException(BaseErrorEnum.SYS_ERROR);
        } finally {
            try {
